...
async function example(){
       ...
       let driver = await new Builder().forBrowser("chrome").build();
        ...
        await driver.get("http://127.0.0.1:5500/coding-projects/unit-conversions/unit-conversions.html");
        ...
        //Selects the "Millimeter to Centimeter" option
        ...
        //Selects the "Fahrenheit to Celsius" option
        ...
        //Selects the "Celsius to Fahrenheit" option
        ...
        //Selects the "Meter to Kilometer" option
        ...
        //Selects the "Kilometer to Meter" option
